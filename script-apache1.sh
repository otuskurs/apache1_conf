...
git add ports.conf
git commit -m 'Конфиги apache1-2'
git config pull.rebase true
git pull https://github.com/otuskurs/apache1_conf.git master
git rebase --skip
else
...
git config pull.rebase true
git pull https://github.com/otuskurs/apache1_conf.git master-www
git rebase --skip
else
